                                 ...
                                 bool isFirstWord) const
{
    ...
    bool lowercaseUsernames = getSettings()->lowercaseUsernames;
    addVecToStringList(
        this->output_, list, maxCount,
        [this, isFirstWord, mentionComma,
         lowercaseUsernames](const UserItem &user) {
            const auto userMention = formatUserMention(
                user.second, isFirstWord, mentionComma, lowercaseUsernames);
